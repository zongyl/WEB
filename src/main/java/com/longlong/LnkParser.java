...
public class LnkParser { 
    ...
    public static void main(String[] args) throws Exception{
    	//C:\Users\long\Desktop\快捷方式
    	String filePath = "";
    	//File file = new File("C:\\ProgramData\\Microsoft\\Windows\\Start Menu\\Programs\\Python 2.7");
    	File file = new File("C:\\Users\\long\\Desktop\\快捷方式");
    	File[] files = file.listFiles();
    	for(File f : files){
    		filePath = f.getAbsolutePath();
    		System.out.println("###########"+filePath);
    		new LnkParser(new File(filePath));
    	}
    }
